...
cc_raw <- read.csv("D:\\Data\\BankChurners.csv")
```
...
The evaluation metric for this competition is AUC (Area Under the Curve) ROC (Receiver Operating Characteristics) curve.
